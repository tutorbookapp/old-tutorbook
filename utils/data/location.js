...
const ARRAY_FIELDS = ['supervisors', 'access'];

const PREFILLED_FIELDS = ['hours', 'config'];
...
const create = async (location = {}, partition = 'default') => {
  ...
  LOCATION_FIELDS.forEach((field) => {
    ...
    location[field] = readline.question(
      "What is the location's " + field + '? '
    );
