...
function parseTutor(t) {
  return {
    ...
    photo:
      t.profile_img && t.profile_img !== ''
        ? 'https://topdogtutor' +
          's.com/sitecontent/profile_pics/' +
          t.profile_img
        : t.gender === 'female'
        ? 'https://tutorbook.app/app/img/female.' + 'png'
        : 'https://tutorbook.app/app/img/male.png',
    bio:
      t.education +
      ' ' +
      t.experience_qualifications +
      ' ' +
      t.hobbies_interests +
      " I'm available " +
      t.available_at +
    ...
    numRatings: 0,
    gender:
      t.gender.charAt(0).toUpperCase() + t.gender.substring(1, t.gender.length),
    located: {
      city: t.city,
    ...
    payments: {
      ...
      policy:
        'Hourly rate is $' +
        new Number(t.hourly_rate).toFixed(2) +
