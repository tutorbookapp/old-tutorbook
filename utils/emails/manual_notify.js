...
function manualTexts() {
    var message = 'Hi Aditya, did you remember to clock into your tutoring' +
    ...
    message = 'Hi Malavika, did you remember to clock into your tutoring' +
        ' appointment with Esther today?' +
        ' Make sure to log unto Tutorbook (tutorbook.app) to track service hours.';
    sendText('650-665-3124', message);
    message = 'Hi Annabel, did your tutor remember to clock into their tutoring' +
