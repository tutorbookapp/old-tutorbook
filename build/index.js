...
var Site = function () {
    ...
    _createClass(Site, [{
        ...
        value: function redirect() {
            var splitLocation = window.location.toString().split('/');
            if (splitLocation.indexOf('app') < 0) {
                ...
                splitLocation.forEach(function (str) {
                    if (splitLocation.indexOf(str) > splitLocation.indexOf('app')) locationParameter += str + '/';
                });
