  ...
  constructor() {
    ...
    switch (error) {
      case '400':
        title = 'Bad Request';
        message =
          'Uh oh, the page you requested does not exist. Did ' +
          'you mean to go to our homepage that does exist?';
        break;
      case '403':
        title = 'Forbidden';
        message =
          "It looks like you're not authorized to access " +
      ...
      case '405':
        ...
        message =
          "Sorry, we couldn't understand your request. Did " +
          'you mean to go to our homepage instead?';
        break;
      case '414':
        title = 'URI Too Long';
        message =
          'Uh oh, the URL you requested was too long. Try ' +
          'again with a shorter one or head over to our homepage:';
        break;
      case '416':
        title = 'Range Unsatisfiable';
        message =
          'Sorry, we encountered a very technical error when ' +
      ...
      case '500':
        title = 'Server Error';
        message =
          "Oops, this one's our bad. Our server encountered " +
      ...
      case '501':
        ...
        message =
          "Oops, this one's our bad. Our server does not " +
      ...
      case '502':
        title = 'Bad Gateway';
        message =
          "Oops, this one's our bad. Our server couldn't " +
      ...
      case '503':
        ...
        message =
          "Oops, this one's our bad. Our server is currently" +
      ...
      case '504':
        ...
        message =
          "Oops, this one's our bad. Our sever couldn't " +
      ...
      default:
        title = 'Error';
        message =
          'Uh oh, it looks like we encountered an error while' +
