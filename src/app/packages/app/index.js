 ...
 *3) Paid tutor flow
 *  [x] Goes to the website and signs up as a tutor
 *  [ ] Goes to settings and enables payments
 *  [ ] Populates profile and payment policies
 *  [ ] Responds to job postings and pupil questions 
 *  [ ] Approves lesson request from pupil and tracks hours/payments through the app
 *4) Supervisor flow
 *  [x] Securely logs in with given credentials
 *  [ ] Dashboard of app activity (statistics on what is going on)
 *  [x] Sets up appointments (through proxy accounts)
 *  [x] Approves/rejects tutor clock[ ]ins/outs at their location(s)
 *  [ ] Tracks their tutors's service hours through the app
