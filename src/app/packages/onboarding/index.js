...
export default class Onboarding extends View {
    ...
    $(page)
      ...
      .append(
        "By continuing, you're " +
          ...
          'and <a href="/legal/#security">Security Policy</a>.'
      )
      .end()
      ...
      .find('#onboarding-input')
      .keydown(() => {
        if ($(page).find('#onboarding-input').val() !== '')
          $(page)
            .find('#onboarding-input')
  ...
  renderSubdomainPage() {
    ...
    const validSubdomain = new RegExp(
    ...
    $(page)
      .find('#onboarding-form')
      .addClass('onboarding__subdomain-form')
      .find('button')
